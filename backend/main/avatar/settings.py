...
# Assuming settings.py is located in /Users/abdullah/Desktop/aira/backend/avatar/
...
GOOGLE_APPLICATION_CREDENTIALS = os.path.join(BASE_DIR, 'googleKeyTranslate.json')
